...
<section id="portfolio" className="portfolio section-bg">
  <div className="container">
    <div className="section-title">
      <h2>Portfolio</h2>
      <p>Dalam portofolio saya, Anda akan menemukan pameran dinamis dari keahlian saya dalam Data Scientist, di mana setiap proyek menceritakan kisah wireframing yang teliti, prototyping inovatif, dan riset berorientasi pengguna. Saat Anda menjelajahi bagian frontend.</p>
    </div>
