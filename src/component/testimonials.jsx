...
<section id="testimonials" className="testimonials section-bg">
  <div className="container">
    <div className="section-title">
      <h2>Testimonials</h2>
      <p>Bekerja dengan [wayne wagiuw] adalah perubahan besar! Keahlian mereka dalam data scientist dan pengembangan frontend mengubah keberadaan digital kami. Solusi inovatif, eksekusi yang mulus, dan komitmen sejati untuk keunggulan - mereka melampaui harapan kami di setiap langkah.</p>
    </div>
