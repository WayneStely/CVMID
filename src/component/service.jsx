...
<section id="services" className="services">
  <div className="container">
    <div className="section-title">
      <h2>Services</h2>
      <p>Sebagai penyedia layanan data scientist dan frontend yang berdedikasi, saya menawarkan pendekatan khusus untuk membuat solusi digital yang menarik secara visual dan berpusat pada pengguna. Dengan fokus pada inovasi dan efisiensi, saya berkomitmen untuk memberikan layanan berkualitas tinggi yang meningkatkan pengalaman pengguna secara keseluruhan dan mendorong kesuksesan proyek Anda.</p>
    </div>
    <div className="row">
